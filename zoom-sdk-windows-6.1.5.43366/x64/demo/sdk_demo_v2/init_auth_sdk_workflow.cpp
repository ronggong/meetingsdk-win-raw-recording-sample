...
void CInitSDKWorkFlow::CustomizeDemoResource()
{
	...
	{
		std::wstring strPNGID = _T("g_logo_zoom_z.svg"); //**** Refer for zWinRes.dll for the id of the icon you want to customize 
		...
		pCustomizeResHelper->AddCustomizedStringResource(ZOOM_SDK_NAMESPACE::SDK_Customized_LiveStream_MenuString_LiveOn_String, strCopyURL.c_str());
