...
ZOOM_SDK_NAMESPACE::SDKError  CustomizedUIRecordMgr::CanIStartLocalRecording()
{
	return CanTheUserStartLocalRecording(0);
}

ZOOM_SDK_NAMESPACE::SDKError CustomizedUIRecordMgr::CanIStartCloudRecording()
{
...
*/
ZOOM_SDK_NAMESPACE::SDKError CustomizedUIRecordMgr::CanTheUserStartLocalRecording(unsigned int userid)
{
	GetRecordController();
	if (!m_pRecordController){
		return ZOOM_SDK_NAMESPACE::SDKERR_INTERNAL_ERROR;
	}
...
*	  when userid=0, the api determine current logined user!
*/
ZOOM_SDK_NAMESPACE::SDKError CustomizedUIRecordMgr::CanTheUserStartCloudRecording(unsigned int userid)
{
	GetRecordController();
	if (!m_pRecordController){
		return ZOOM_SDK_NAMESPACE::SDKERR_INTERNAL_ERROR;
