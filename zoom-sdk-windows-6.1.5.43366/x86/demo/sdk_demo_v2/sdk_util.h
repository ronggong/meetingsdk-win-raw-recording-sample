...
public:
	...
	{
		Call_SINK_Pool(ISDKInMeetingServiceMgrEvent, _sdk_inmeeting_service_mgr_event_pool, onJoin3rdPartyTelephonyAudio(audioInfo))
	}
	virtual void onMuteOnEntryStatusChange(bool bEnabled)
	{
		Call_SINK_Pool(ISDKInMeetingServiceMgrEvent, _sdk_inmeeting_service_mgr_event_pool, onMuteOnEntryStatusChange(bEnabled))
	}
	...
	{
		Call_SINK_Pool(ZOOM_SDK_NAMESPACE::IMeetingChatCtrlEvent, _chat_servic_event_pool, onChatStatusChangedNotification(status_))
	}
	...
	{
		Call_SINK_Pool(ZOOM_SDK_NAMESPACE::IMeetingChatCtrlEvent, _chat_servic_event_pool, onFileSendStart(sender))
	}
	virtual void onFileReceived(ZOOM_SDK_NAMESPACE::ISDKFileReceiver* receiver) 
	{
		Call_SINK_Pool(ZOOM_SDK_NAMESPACE::IMeetingChatCtrlEvent, _chat_servic_event_pool, onFileReceived(receiver))
	}
	virtual void onFileTransferProgress(ZOOM_SDK_NAMESPACE::SDKFileTransferInfo* info) 
	{
		Call_SINK_Pool(ZOOM_SDK_NAMESPACE::IMeetingChatCtrlEvent, _chat_servic_event_pool, onFileTransferProgress(info))
	}
	...
	{
		Call_SINK_Pool(ZOOM_SDK_NAMESPACE::IMeetingParticipantsCtrlEvent, _meeting_participants_ctr_event_pool, onInMeetingUserAvatarPathUpdated(userID))
	}
	...
	{
		Call_SINK_Pool(ISDKInMeetingServiceMgrEvent, _sdk_inmeeting_service_mgr_event_pool, onRecordPrivilegeChanged(bCanRec))
	}
